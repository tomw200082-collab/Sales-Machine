...
| U-019 | ארבע רשומות-השלילה ירדו ממחירון הלקוחות ומהספר, ו**עדיין ניתנות להזמנה בשופיפיי**: `GT-SHI-CER-50` ₪65 · `GT-SHI-CER-30` ₪38 · `GTCFR-GTCOC-FRO` ₪75 · `AP-JUG-NEA` ₪36. לארכב? | טום — `open-items/alex-meeting.md` §7ב |
